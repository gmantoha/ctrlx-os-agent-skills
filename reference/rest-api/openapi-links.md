...
- REST API documentation root: https://boschrexroth.github.io/rest-api-description/index.html
...
Raw OpenAPI JSON files are published under paths like:

- `https://boschrexroth.github.io/rest-api-description/ctrlx-automation/ctrlx-core/<app>/<api>/<file>.openapi.json`
- `https://boschrexroth.github.io/rest-api-description/ctrlx-automation/ctrlx-works/<api>/<file>.openapi.json`

Use the live documentation first. Use `openapi-snapshot/manifest.md` to locate the local fallback copy.
